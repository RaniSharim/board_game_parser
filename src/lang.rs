...
// sha3: 94215b4f10c2d89ebeba990176b54c91e212b74795657d6a1b314d7ae157ac
use std::str::FromStr;
...
mod __parse__DrawAction {
    ...
    pub struct DrawActionParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl DrawActionParser {
        pub fn new() -> DrawActionParser {
    ...
    ) -> Option<Result<i32,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            5 => {
                // __DrawAction = DrawAction => ActionFn(0);
    ...
    {
        // CardDef = r#"[a-zA-Z]+"#, "card" => ActionFn(4);
    ...
    {
        // DrawAction = "draw", Num, CardDef => ActionFn(5);
...
pub use self::__parse__DrawAction::DrawActionParser;
#[cfg_attr(rustfmt, rustfmt_skip)]
mod __intern_token {
    #![allow(unused_imports)]
    use std::str::FromStr;
